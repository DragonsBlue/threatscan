...
**Built by Gritty | 7Networks Security | District IT**

ThreatScan is a custom Microsoft Outlook Web Add-in that scans emails in real time for phishing, social engineering, malicious attachments, and suspicious senders. It provides a 0–100 risk score with color-coded results and itemized threat findings.
...
| Report Phishing button (Power Automate) | 🔧 In Progress |
| Microsoft Defender verdict integration | 📋 Planned |
| Claude AI contextual scoring | 📋 Planned |
...
```
https://dragonsblue.github.io/threatscan/
```

Deployed to Microsoft 365 via **Integrated Apps** in the M365 Admin Center.
...
- [ ] Ribbon button via VersionOverrides manifest
- [ ] Report Phishing → Power Automate → IT mailbox notification
- [ ] Microsoft Defender for Office 365 verdict via Graph API
- [ ] Claude AI contextual email analysis
- [ ] Email Header Analyzer add-in (separate deployment)
...
*ThreatScan v1.0.0 · 7Networks Security · Built with Microsoft Office JS API*
